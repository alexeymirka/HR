import {
  ...
  import { API_URL_INTERNSHIP } from "../api/ApiUrls";
  ...
  export default function Internship({id}) {
    ...
    function handleSubmit(event) {
      ...
      axios
        ...
        .catch((error) => {
          setShowError(true)
          setErrorMessage('Результаты стажировки уже оценены');
      });
    }
    ...
    return (
            <Card>
              <CardHeader>
                <h5 className="title text-center">Стажировка</h5>
              </CardHeader>
              <CardBody>
                <Form>
                  <Row>
